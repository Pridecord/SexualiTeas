...
publishing {
    publications.create<MavenPublication>("mavenJava") {
        ...
        pom {
            ...
            description.set("A Minecraft: Java Edition plugin that allows players to set identities.")
            ...
            scm {
                connection.set("scm:git:git://github.com/lucyy-mc/Identities.git")
                developerConnection.set("scm:git:git://github.com/lucyy-mc/Identities.git")
                url.set("https://github.com/lucyy-mc/Identities")
            }
        }
    }
